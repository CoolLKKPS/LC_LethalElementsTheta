...
namespace VoxxWeatherPlugin.Utils
{
    public sealed class Configuration
    {
        // Config entries
        #region Weather
        public ConfigEntry<bool> EnableHeatwaveWeather; //
        public ConfigEntry<bool> EnableSolarFlareWeather; //
        public ConfigEntry<bool> EnableSnowfallWeather; //
        public ConfigEntry<bool> EnableBlizzardWeather; //
        public ConfigEntry<bool> EnableToxicSmogWeather; //
        #endregion

        #region Heatwave
        public ConfigEntry<float> HeatwaveParticlesSpawnRate; //
        public ConfigEntry<float> TimeUntilStrokeMin; //
        public ConfigEntry<float> TimeUntilStrokeMax; //
        public ConfigEntry<float> HeathazeDistortionStrength; //
        public ConfigEntry<float> HeathazeFilterMultiplier; //
        #endregion

        #region Solar Flare
        public ConfigEntry<uint> AuroraHeight; //
        public ConfigEntry<float> AuroraSpawnAreaBox; //
        public ConfigEntry<float> AuroraVisibilityThreshold; //
        public ConfigEntry<float> AuroraSpawnRate; //
        public ConfigEntry<float> AuroraSize; //
        public ConfigEntry<bool> DistortOnlyVoiceDuringSolarFlare; //
        public ConfigEntry<float> BatteryDrainMultiplier; //
        public ConfigEntry<bool> DrainBatteryInFacility; //
        public ConfigEntry<float> NoiseStaticLevel; //
        public ConfigEntry<bool> DoorMalfunctionEnabled; //
        public ConfigEntry<bool> RadMechMalfunctionEnabled; //
        public ConfigEntry<bool> TurretMalfunctionEnabled; //
        public ConfigEntry<bool> LandmineMalfunctionEnabled; //
        public ConfigEntry<float> RadMechMalfunctionChance; //
        public ConfigEntry<float> RadMechReactivationChance; //
        public ConfigEntry<float> TurretMalfunctionChance; //
        public ConfigEntry<float> RadMechStunDuration; //
        public ConfigEntry<float> RadMechReactivateDelay; //
        public ConfigEntry<float> TurretMalfunctionDelay; //
        public ConfigEntry<float> DoorMalfunctionChance; //
        public ConfigEntry<float> LandmineMalfunctionChance; //
        #endregion

        #region Snowfall
        public ConfigEntry<float> minSnowHeight; //
        public ConfigEntry<float> maxSnowHeight; //
        public ConfigEntry<float> minTimeToFullSnow; //
        public ConfigEntry<float> maxTimeToFullSnow; //
        public ConfigEntry<bool> freezeWater; //
        public ConfigEntry<float> underSnowFilterMultiplier; //
        public ConfigEntry<float> frostbiteFilterMultiplier; //
        public ConfigEntry<int> frostbiteDamage; //
        public ConfigEntry<float> frostbiteDamageInterval; //
        public ConfigEntry<float> timeToWarmUp; //
        public ConfigEntry<bool> enableEasterEgg; //
        public ConfigEntry<bool> patchModdedEnemies; //
        public ConfigEntry<bool> snowAffectsEnemies; //
        public ConfigEntry<string> enemySnowBlacklist; //
        #endregion

        #region Blizzard
        public ConfigEntry<float> minSnowHeightBlizzard; //
        public ConfigEntry<float> maxSnowHeightBlizzard; //
        public ConfigEntry<float> minTimeToFullSnowBlizzard; //
        public ConfigEntry<float> maxTimeToFullSnowBlizzard; //
        public ConfigEntry<float> minTimeUntilFrostbite; //
        public ConfigEntry<float> maxTimeUntilFrostbite; //
        public ConfigEntry<float> minWindForce; //
        public ConfigEntry<float> maxWindForce; //
        public ConfigEntry<float> minWaveInterval; //
        public ConfigEntry<float> maxWaveInterval; //
        public ConfigEntry<int> minWaveCount; //
        public ConfigEntry<int> maxWaveCount; //
        public ConfigEntry<int> chillingWaveDamage; //
        public ConfigEntry<float> blizzardAmbientVolume; //
        public ConfigEntry<float> blizzardWaveVolume; //
        public ConfigEntry<float> blizzardFogMeanFreePathMin; //
        public ConfigEntry<float> blizzardFogMeanFreePathMax; //
        #endregion

        #region Snow & Blizzard Graphics
        public ConfigEntry<float> snowParticlesMultiplier; //
        public ConfigEntry<float> blizzardWaveParticlesMultiplier; //
        public ConfigEntry<bool> useParticleBlizzardFog; //
        public ConfigEntry<bool> useVolumetricBlizzardFog; //
        public ConfigEntry<bool> snowVfxLighting; //
        public ConfigEntry<bool> blizzardWaveVfxLighting; //
        public ConfigEntry<bool> useOpaqueSnowMaterial; //
        public ConfigEntry<bool> snowCastsShadows; //
        public ConfigEntry<bool> addFootprints; //
        public ConfigEntry<int> trackedEntityNumber; //
        public ConfigEntry<int> depthBufferResolution; //
        public ConfigEntry<int> trackerMapResolution; //
        public ConfigEntry<int> snowDepthMapResolution; //
        public ConfigEntry<bool> bakeSnowDepthMipmaps; //
        public ConfigEntry<int> PCFKernelSize; //
        public ConfigEntry<int> minTesselationFactor; //
        public ConfigEntry<int> maxTesselationFactor; //
        public ConfigEntry<bool> adaptiveTesselation; //
        public ConfigEntry<float> tesselationFadeDistance; //
        public ConfigEntry<float> tesselationMaxDistance; //
        public ConfigEntry<bool> softSnowEdges; //
        public ConfigEntry<bool> enableSnowTracks; //
        public ConfigEntry<float> tracksCameraFPS;//
        public ConfigEntry<bool> enableVFXCollisions; //
        public ConfigEntry<float> collisionCamerasFPS;//
        #endregion

        #region Snow & Blizzard Mesh and Terrain Processing
        public ConfigEntry<bool> asyncProcessing; //
        public ConfigEntry<string> meshProcessingWhitelist; //
        public ConfigEntry<bool> subdivideMesh; //
        public ConfigEntry<bool> smoothMesh; //
        public ConfigEntry<bool> useLevelBounds; //
        // TerraMesh related
        public ConfigEntry<bool> refineMesh; //
        public ConfigEntry<bool> carveHoles; //
        public ConfigEntry<bool> useMeshCollider; //
        public ConfigEntry<int> targetVertexCount; //
        public ConfigEntry<int> minMeshStep; //
        public ConfigEntry<int> maxMeshStep; //
        public ConfigEntry<float> falloffRatio; //
        #endregion

        #region Toxic Smog
        public ConfigEntry<float> ToxicDamageInterval; //
        public ConfigEntry<int> ToxicDamageAmount; //
        public ConfigEntry<float> PoisoningRemovalMultiplier; //
        public ConfigEntry<float> MinFreePath; //
        public ConfigEntry<float> MaxFreePath; //
        public ConfigEntry<int> MinFumesAmount; //
        public ConfigEntry<int> MaxFumesAmount; //
        public ConfigEntry<float> FactoryAmountMultiplier; //
        #endregion
        ...
        public Configuration(ConfigFile cfg)
        {
            ...
            #region Weather
            EnableHeatwaveWeather = cfg.Bind("Weather", "EnableHeatwaveWeather", true, "Enable or disable Heatwave weather");
            EnableSolarFlareWeather = cfg.Bind("Weather", "EnableSolarFlareWeather", true, "Enable or disable Solar Flare weather");
            EnableSnowfallWeather = cfg.Bind("Weather", "EnableSnowfallWeather", true, "Enable or disable Snowfall weather");
            EnableBlizzardWeather = cfg.Bind("Weather", "EnableBlizzardWeather", true, "Enable or disable Blizzard weather");
            EnableToxicSmogWeather = cfg.Bind("Weather", "EnableToxicSmogWeather", true, "Enable or disable Toxic Smog weather");
            #endregion

            #region Heatwave
            HeatwaveParticlesSpawnRate = cfg.Bind("Heatwave",
                                                    "ParticlesSpawnRate",
                                                    20f,
                                                    new ConfigDescription("Spawn rate of Heatwave particles. Particles per second",
                                                                            new AcceptableValueRange<float>(0, 42)));
            TimeUntilStrokeMin = cfg.Bind("Heatwave",
                                            "TimeUntilStrokeMin",
                                            40f,
                                            new ConfigDescription("Minimal time in seconds until heatstroke (min)",
                                                                    new AcceptableValueRange<float>(1, 9999f)));
            TimeUntilStrokeMax = cfg.Bind("Heatwave",
                                            "TimeUntilStrokeMax",
                                            80f,
            ...
            HeathazeDistortionStrength = cfg.Bind("Heatwave",
            ...
            HeathazeFilterMultiplier = cfg.Bind("Heatwave",
            ...
            #region Solar Flare
            AuroraHeight = cfg.Bind("SolarFlare",
                                        "AuroraHeight",
                                        (uint)120,
                                        "Height of the Aurora effect above the ground");
            AuroraSpawnAreaBox = cfg.Bind("SolarFlare",
                                                "AuroraSpawnArea",
                                                500f,
            ...
            RadMechMalfunctionChance = cfg.Bind("SolarFlare",
            ...
            RadMechReactivationChance = cfg.Bind("SolarFlare",
            ...
            TurretMalfunctionChance = cfg.Bind("SolarFlare",
            ...
            RadMechStunDuration = cfg.Bind("SolarFlare",
                                                "RadMechStunDuration",
                                                4f,
            ...
            minTimeToFullSnow = cfg.Bind("Snowfall",
                                            "minTimeToFullSnow",
                                            0.7f,
                                            new ConfigDescription("Minimum fraction of the day until snow reaches max height. Actual time is random between min and max.",
                                                                new AcceptableValueRange<float>(0, 1f)));
            maxTimeToFullSnow = cfg.Bind("Snowfall",
                                            "maxTimeToFullSnow",
                                            1f,
                                            new ConfigDescription("Maximum fraction of the day until snow reaches max height. Actual time is random between min and max.",
                                                                new AcceptableValueRange<float>(0, 1f)));
            freezeWater = cfg.Bind("Snowfall",
                                    "freezeWater",
                                    true,
                                    "Freeze water during snowfall and blizzard weather");
            underSnowFilterMultiplier = cfg.Bind("Snowfall",
                                                    ...
                                                    new ConfigDescription("Multiplier for the effect visible when player's head is covered in snow. Lower values make the filter less intense. 0 will disable the filter",
                                                                        new AcceptableValueRange<float>(0, 1f)));
            frostbiteFilterMultiplier = cfg.Bind("Snowfall",
                                                    ...
                                                    new ConfigDescription("Multiplier for the frostbite filter. Lower values make the filter less intense. 0 will disable the filter",
                                                                        new AcceptableValueRange<float>(0, 1f)));
            frostbiteDamage = cfg.Bind("Snowfall",
                                        "frostbiteDamage",
                                        10,
            ...
            frostbiteDamageInterval = cfg.Bind("Snowfall",
            ...
            #region Blizzard
            minSnowHeightBlizzard = cfg.Bind("Blizzard",
            ...
            maxSnowHeightBlizzard = cfg.Bind("Blizzard",
            ...
            minTimeToFullSnowBlizzard = cfg.Bind("Blizzard",
            ...
            maxTimeToFullSnowBlizzard = cfg.Bind("Blizzard",
            ...
            minTimeUntilFrostbite = cfg.Bind("Blizzard",
            ...
            maxTimeUntilFrostbite = cfg.Bind("Blizzard",
            ...
            maxWaveCount = cfg.Bind("Blizzard",
                                        "maxWaveCount",
                                        5,
            ...
            blizzardFogMeanFreePathMax = cfg.Bind("Blizzard",
            ...
            #region Snow & Blizzard Graphics
            snowParticlesMultiplier = cfg.Bind("Snow Graphics",
            ...
            blizzardWaveParticlesMultiplier = cfg.Bind("Snow Graphics",
                                                        ...
                                                        new ConfigDescription("Multiplier for the amount of blizzard wave particles. Lower values may reduce performance impact but also reduce density of particles.",
                                                                            new AcceptableValueRange<float>(0, 10f)));
            useParticleBlizzardFog = cfg.Bind("Snow Graphics",
            ...
            useVolumetricBlizzardFog = cfg.Bind("Snow Graphics",
            ...
            snowVfxLighting = cfg.Bind("Snow Graphics",
                                        "snowVfxLighting",
                                        false,
            ...
            blizzardWaveVfxLighting = cfg.Bind("Snow Graphics",
            ...
            useOpaqueSnowMaterial = cfg.Bind("Snow Graphics",
            ...
            trackedEntityNumber = cfg.Bind("Snow Graphics",
                                            "trackedEntityNumber",
                                            64,
            ...
            depthBufferResolution = cfg.Bind("Snow Graphics",
            ...
            trackerMapResolution = cfg.Bind("Snow Graphics",
            ...
            snowDepthMapResolution = cfg.Bind("Snow Graphics",
                                                ...
                                                new ConfigDescription("Resolution of the baked texture used to store snow depth data. Higher values increase quality but also memory usage. MUST be a power of 2!",
                                                                    new AcceptableValueRange<int>(256, 8192)));
            bakeSnowDepthMipmaps = cfg.Bind("Snow Graphics",
            ...
            PCFKernelSize = cfg.Bind("Snow Graphics",
                                        "PCFKernelSize",
                                        12,
            ...
            minTesselationFactor = cfg.Bind("Snow Graphics",
            ...
            maxTesselationFactor = cfg.Bind("Snow Graphics",
                                                ...
                                                new ConfigDescription("Maximum tesselation factor for snow material. Higher values increase quality but also memory usage. Number represents how many times each triangle is divided.",
                                                                    new AcceptableValueRange<int>(1, 32)));
            adaptiveTesselation = cfg.Bind("Snow Graphics",
                                                "adaptiveTesselation",
                                                true,
            ...
            tesselationFadeDistance = cfg.Bind("Snow Graphics",
            ...
            tesselationMaxDistance = cfg.Bind("Snow Graphics",
            ...
            softSnowEdges = cfg.Bind("Snow Graphics",
                                        "softSnowEdges",
                                        false,
            ...
            enableSnowTracks = cfg.Bind("Snow Graphics",
                                            "enableSnowTracks",
                                            true,
            ...
            tracksCameraFPS = cfg.Bind("Snow Graphics",
                                            "tracksCameraFPS",
                                            5f,
            ...
            enableVFXCollisions = cfg.Bind("Snow Graphics",
            ...
            collisionCamerasFPS = cfg.Bind("Snow Graphics",
                                            "collisionCamerasFPS",
                                            10f,
            ...
            asyncProcessing = cfg.Bind("Mesh & Terrain Processing",
                                        "asyncProcessing",
                                        true,
            ...
            meshProcessingWhitelist = cfg.Bind("Mesh & Terrain Processing",
            ...
            subdivideMesh = cfg.Bind("Mesh & Terrain Processing",
                                        "subdivideMesh",
                                        true,
            ...
            smoothMesh = cfg.Bind("Mesh & Terrain Processing",
                                    "smoothMesh",
                                    true,
            ...
            useLevelBounds = cfg.Bind("Mesh & Terrain Processing",
                                        "useLevelBounds",
                                        true,
            ...
            refineMesh = cfg.Bind("Mesh & Terrain Processing",
                                    "refineMesh",
                                    true,
            ...
            targetVertexCount = cfg.Bind("Mesh & Terrain Processing",
                                            "targetVertexCount",
                                            -1,
            ...
            minMeshStep = cfg.Bind("Mesh & Terrain Processing",
                                    "minMeshStep",
                                    1,
            ...
            maxMeshStep = cfg.Bind("Mesh & Terrain Processing",
                                    "maxMeshStep",
                                    32,
                                    new ConfigDescription("TerraMesh. Maximum step size for the produced mesh. Outside of calculated playable level bounds the step size will be gradually increased to this value. Step size will rounded up to the nearest power of 2.",
                                                        new AcceptableValueRange<int>(1, 128)));
            falloffRatio = cfg.Bind("Mesh & Terrain Processing",
                                    "falloffRatio",
                                    3f,
            ...
            MinFreePath = cfg.Bind("Toxic Smog",
                                    "MinFreePath",
                                    8f,
            ...
            MaxFreePath = cfg.Bind("Toxic Smog",
                                    "MaxFreePath",
                                    25f,
                                    new ConfigDescription("Maximum free path length for toxic smog in meters. Actual free path length is random between min and max.",
                                                        new AcceptableValueRange<float>(0, 256f)));
            MinFumesAmount = cfg.Bind("Toxic Smog",
                                        "MinFumesAmount",
                                        40,
